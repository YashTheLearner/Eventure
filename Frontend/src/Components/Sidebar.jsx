...
import eventure from "../assets/eventure.png"; // Import the Eventure logo
...
const Sidebar = ({ isSidebarOpen, setIsSidebarOpen, setIsAuthenticated }) => {
  ...
  return (
    <div
      className={` fixed top-0 bottom-0 right-0 p-2 w-[300px] overflow-y-auto text-center bg-gray-900 shadow h-screen transition-transform duration-1000 ${
        isOpen ? "translate-x-0" : "translate-x-full"
      }`}
    >
      <div className="text-gray-100 text-xl">
        <div className="px-4 py-2 mt-1 flex items-center rounded-md justify-between">
<div className="flex">          <img src={eventure} className="h-[40px]" alt="Eventure Logo" />
venture</div>
